...
function OnGUI () {
	...
	if (isShowScore) {
		GUI.Label(Rect (thirdStyle.fontSize, thirdStyle.fontSize, 10*thirdStyle.fontSize, 2*thirdStyle.fontSize), "鼠群涌过 " + GameInfo.theScore + " 米", thirdStyle);
		GUI.Label(Rect (thirdStyle.fontSize, 2.5*thirdStyle.fontSize, 10*thirdStyle.fontSize, 2*thirdStyle.fontSize), "鼠群规模 " + GameInfo.ratNumber + " 只", thirdStyle);
	}
